...
EPOCHS = 20
BS = 32
NETWORK = "ResNet50V2_Dense512_KFold10_60ml"

dataset = r"C:\Users\asus\Downloads\KP PT. Bumi Alam Segar\Dataset\60";
...
for imagePath in imagePaths:
    ...
    # Masukkan / Impor gambar dengan piksel (320x160) dan Lakukan prosesnya terlebih dahulu
    image = load_img(imagePath, target_size=(320, 160, 3))
...
txt_path = 'class_labels_60ml.txt'
...
headModel = baseModel.output  # outshape = 10 x 5 x 1280 channel
